...
(function() {
  var __dirname, averageCop, copertures, countries, drawViz, fix, inverseFix, maxCop, minCop, modality, modalitySet, nameDis,
  ...
  drawViz = function(error, data) {
    ...
    cell = function(data, country, disease, average, dx, dy, showAxis) {
      var avBar, bar, bars, cellG, dw, mod, w;
      if (dx == null) {
        dx = 0;
      }
      if (dy == null) {
    ...
    return xLabels.selectAll("text").data(["DTP3 (%)", "Pol3 (%)", "MCV2 (%)"]).enter().append("text").text(function(d) {
      return d;

...
(function() {
  var clips, createFilter, drawNebula, focus, focusCircle, gaussianDist, getNodes, getTopics, h, height, j, len, m, mainTopic, nebulaLine, nebulaPoints, nebulas, nodes, paths, rScale, rand, randomInt, rectDist, ref, session, svg, t, test, topicPoints, vertices, viz, w, width, xCoords, yCoords;

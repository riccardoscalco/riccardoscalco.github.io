...
(function() {
  var addEdge, arrayIntersect, arrayIntersect_, choose, deleteEdge, deleteNeighbour, deleteNode, dist, edgeNotExists, edgeObject, entities, firstGraphObject, getType, i, isTopic, keywords, linkToTopic, modifyGraph, nodeExists, nodeObject, numberOfTopics, randEdge, randomBoolean, randomBooleanOutlier, randomChoice, randomFloat, randomSourcesList, resetGraph, topics, updateNeighboursAndTopics, updateNode, vary;
  ...
  nodeObject = function(n, type, isnew) {
    ...
    return {
      ...
      "emergence": {
        "new": setNew,
        "metric": em,
        "outlier": setNew ? false : randomBooleanOutlier()
      },
